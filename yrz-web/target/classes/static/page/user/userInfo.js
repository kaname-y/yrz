...
layui.use(['form', 'layer', 'upload', 'laydate', "address"], function () {
    ...
    form.on("submit(changeUser)", function (data) {
        ...
        userInfoHtml = {
            ...
            'ubirthday': $(".userBirthday").value(),
            'province': data.field.province,
            'city': data.field.city,
            'area': data.field.area,
            'uemail': $(".userEmail").value(),
            'phonecheck': $("#phonecheck").value(),
    ...
    //     var citys;
    //     // $("#uname").val(userInfo.uname); //用户名
    //     $(".userSex input[value=" + userInfo.sex + "]").attr("checked", "checked"); //性别
    //     $(".userPhone").val(userInfo.uphone); //手机号
    //     $(".userBirthday").val(userInfo.ubirthday); //出生年月
    //     //填充省份信息，同时调取市级信息列表
    ...
    //         }
    //     }
    //     $(".userEmail").val(userInfo.uemail); //用户邮箱
