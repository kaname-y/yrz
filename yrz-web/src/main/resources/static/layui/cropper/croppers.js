...
layui.config({
    ...
    var html = "<div class=\"layui-fluid showImgEdit\" style=\"display: none\">\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:100%;height:200px;overflow:hidden;background-color:rgba(0,0,0,0.2)\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
        "        <div class=\"layui-col-md9 layui-col-xs12\">\n" +
        "            <div class=\"layui-row\">\n" +
        "                <div class=\"layui-col-md6 layui-col-xs10\">\n" +
        ...
        "                </div>\n" +
        "                <div class=\"layui-col-md5 layui-col-xs2\" style=\"text-align: right;\">\n" +
